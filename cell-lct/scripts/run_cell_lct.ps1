...
$prepareScript = Resolve-RuntimeFile -Name 'prepare_geometry_cache.py' -SubDir 'python'
$runtimePath = Resolve-RuntimeFile -Name 'cell_lct_cached_runtime.jsx' -SubDir 'illustrator'
