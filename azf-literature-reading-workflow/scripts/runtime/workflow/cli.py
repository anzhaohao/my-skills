...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--mineru-image", default="mineru:4.0.2-vllm0.21.0")
    ...
    p.add_argument("--docker-image", default="mineru:4.0.2-vllm0.21.0")
    p.add_argument("--mineru-tier", choices=["flash", "basic", "standard", "advanced"], default="standard")
