...
- 2026-07-25：统一论文顶部基本信息展示；精确匹配时增加 `中科院升级版YYYY X区` 徽章，预印本、未收录、名称歧义或未启用时改为下一行小字说明原因并提醒人工核验。
...
- 2026-07-27：运行数据库、日志和进度状态迁移到项目 `runtime/`；配置管理器增加一次确认后启动本周周报、实时进度条和打开运行目录功能。
